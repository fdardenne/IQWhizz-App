...
create table Users
(username text not null primary key,password text not null,language text not null default 'en',birth_date integer not null,mail text not null unique,registration_date integer not null,
